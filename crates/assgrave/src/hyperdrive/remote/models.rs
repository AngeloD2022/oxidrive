...
//
// use generated_module::Application;
//
// fn main() {
//     let json = r#"{"answer": 42}"#;
//     let model: Application = serde_json::from_str(&json).unwrap();
// }
...
pub struct Application {
    ...
    pub dependencies: Option<DependenciesClass>,
    pub system_requirement: SystemRequirement,
    #[serde(rename = "version")]
    pub version: String,
    pub ngl_licensing_info: Option<NglLicensingInfo>,
    ...
    pub is_non_cc_product: bool,
    pub compression_type: String,
    pub minimum_supported_client_version: String,
    pub soft_dependencies: Option<DependenciesClass>,
...
pub struct AddRemoveInfo {
    ...
    pub display_version: SupportedLanguages,
...
#[serde(rename_all = "PascalCase")]
pub struct Url {
    pub stage: SupportedLanguages,
    pub prod: SupportedLanguages,
}
...
pub struct Package {
    ...
    pub package_scheme: PackageScheme,
...
#[serde(rename_all = "PascalCase")]
pub struct Features {
    pub feature: Vec<Option<serde_json::Value>>,
}

#[derive(Serialize, Deserialize)]
#[serde(rename_all = "kebab-case")]
pub enum PackageScheme {
    #[serde(rename = "hd-standard")]
    HdStandard,
}
...
pub struct SystemRequirement {
    pub supported_os_version_range: Option<Vec<PreviousVersionRange>>,
...
#[serde(rename_all = "camelCase")]
pub struct Build {
    pub ngl_licensing_info: NglLicensingInfoClass,
    pub id: String,
    #[serde(rename = "type")]
...
pub struct LanguageSet {
    pub locales: Locales,
    pub urls: Urls,
    pub dependencies: LanguageSetDependencies,
...
#[derive(Serialize, Deserialize)]
pub struct LanguageSetDependencies {
    pub dependency: Option<Vec<DependencyElement>>,
}
