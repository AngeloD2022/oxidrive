...
mod tests {
    ...
    fn hyperdrive_lzma2() {
        ...
        let file2 = fs::read("/Users/angelodeluca/RustroverProjects/assgrave/dl_test/PHSP/AdobePhotoshop26-SuperCafModels/AdobePhotoshop26-SuperCafModels.pimx").unwrap();
