...
mod tests {
    ...
    #[test]
    fn hyperdrive_lzma2() {
        let file1 = fs::read("/Users/angelodeluca/RustroverProjects/oxidrive/dl_test/COSY/CoreSync-mul/CoreSync-mul.pimx").unwrap();
        // let file2 = fs::read("/Users/angelodeluca/RustroverProjects/oxidrive/dl_test/ILST/AdobeIllustrator30-CoreArm/AdobeIllustrator30-CoreArm.pimx").unwrap();
