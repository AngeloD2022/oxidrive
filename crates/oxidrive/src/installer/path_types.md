...
| `AdobeProgramFiles`     |                                                                | (`[ProgramFilesX86]\|[ProgramFiles]`) + `\Adobe` |
| `AdobeCommon`           |                                                                | (`[CommonX86]\|[Common]`) + `\Adobe`             |

> [!NOTE]
> It is not immediately clear from static analysis of HDPIM.dll what determines `[%NAME%X86]` being chosen over `[%NAME%]`.
